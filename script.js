...
const translations = {
    ja: {
        ...
        "nav-details": "配布データ",
        "hero-title": "🎍 謹賀新年 🏮<br>ポテトの妖精「ポテトくん」",
    ...
    en: {
        ...
        "hero-title": "🎍 Happy New Year! 🏮<br>Potato Fairy 'PotatoKun'",
    ...
    es: {
        ...
        "hero-title": "🎍 ¡Feliz Año Nuevo! 🏮<br>Hada de la Patata 'PotatoKun'",
    ...
    zh: {
        ...
        "nav-details": "发放数据",
        "hero-title": "🎍 新年快乐! 🏮<br>土豆精灵“PotatoKun”",
    ...
    ko: {
        ...
        "nav-details": "배포 데이터",
        "hero-title": "🎍 새해 복 많이 받으세요! 🏮<br>감자 요정 '포테토군'",
